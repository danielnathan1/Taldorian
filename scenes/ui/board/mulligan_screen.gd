# scenes/ui/board/mulligan_screen.gd
extends Control
...
func _notification(what: int) -> void:
	# is_node_ready() garante que @onready vars já foram resolvidos.
	# Sem isso, NOTIFICATION_VISIBILITY_CHANGED pode chegar antes de _ready().
...
func _rebuild_cards() -> void:
	...
	# Expande o CardsRow para quase a tela toda, para cartas ficarem maiores
